...
function apply_img(file,external){
    ...
    if (external!=""){
        ...
        if(image_select_window){
        	var field = window_parent.Ext.getCmp(image_select_window.custom_variables.filed_id);
	        field.setValue(path+file);
	        var image = window_parent.Ext.getCmp(image_select_window.custom_variables.image_id);
